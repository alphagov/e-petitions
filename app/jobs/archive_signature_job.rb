class ArchiveSignatureJob < ApplicationJob
  queue_as :high_priority

  def perform(petition, archived_petition, signature_ids)
    signatures = petition.signatures.order(:id).find(signature_ids)
