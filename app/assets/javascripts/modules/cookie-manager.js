...
const buildCookieFromObject = function (name, object) {
  return buildCookie(name, btoa(JSON.stringify(object)));
}
...
class CookieManager {
  constructor(root) {
    this.cookieName = 'uk-petitions.cookie-policy';
  ...
  saveCookiePreferences(accept) {
    ...
    document.cookie = buildCookieFromObject(this.cookieName, this.policyCookie);
  }
