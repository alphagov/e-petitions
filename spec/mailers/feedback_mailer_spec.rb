...
RSpec.describe FeedbackMailer, type: :mailer do
  describe "send_feedback" do
    ...
    context "when the petition link or title contains a petition url" do
      let(:title) { "https://petition.senedd.wales/petitions/200000" }

      it "creates a link to the petition" do
        expect(mail.html).to match('<a href="https://petition.senedd.wales/petitions/200000">https://petition.senedd.wales/petitions/200000</a>')
      end
    end
