...
RSpec.describe Archived::Signature, type: :model do
  ...
  describe "validations" do
    it { is_expected.to validate_presence_of(:name).with_message(/provide your full name/i) }
    it { is_expected.to validate_presence_of(:email).with_message(/provide your email address/i) }
