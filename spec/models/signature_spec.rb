...
RSpec.describe Signature, type: :model do
  ...
  context "validations" do
    ...
    it { is_expected.to allow_value("Please click this petitions.senedd.wales for a special offer").for(:name) }
    it { is_expected.not_to allow_value("Please click this https://petitions.senedd.wales for a special offer").for(:name) }
