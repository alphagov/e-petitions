...
RSpec.describe "API request to trending petitions", type: :request, show_exceptions: true do
  ...
  describe "links" do
    ...
    it "returns a link to itself" do
      ...
      expect(response).to be_successful
      expect(links).to include("self" => "https://petitions.senedd.wales/trending.json")
    end
  end
        ...
        a_collection_containing_exactly(
          {
            "type" => "petition", "id" => 100123, "links" => {
              "self" => "https://petitions.senedd.wales/petitions/100123.json"
            }, "attributes" => {
          ...
          },
          {
            "type" => "petition", "id" => 100321, "links" => {
              "self" => "https://petitions.senedd.wales/petitions/100321.json"
            }, "attributes" => {
          ...
          },
          {
            "type" => "petition", "id" => 100213, "links" => {
              "self" => "https://petitions.senedd.wales/petitions/100213.json"
            }, "attributes" => {
          ...
          },
          {
            "type" => "petition", "id" => 100231, "links" => {
              "self" => "https://petitions.senedd.wales/petitions/100231.json"
            }, "attributes" => {
