  ...
  context "when logged in as a moderator" do
    ...
    describe "GET /admin/petitions" do
      ...
      context "when searching by id" do
        ...
        it "redirects to the admin petition page" do
          expect(response).to redirect_to("https://moderate.petition.parliament.wales/admin/petitions/100000")
        end
      end
    end
    ...
    describe "POST /admin/petitions/:id/resend" do
      ...
      context "when the petition exists" do
        ...
        it "redirects to the admin petition page" do
          expect(response).to redirect_to("https://moderate.petition.parliament.wales/admin/petitions/#{petition.to_param}")
        end
        ...
        it "sends a copy of the email to the feedback address" do
          expect(mailbox_for("petitionscommittee@parliament.wales").last).to have_subject("Action required: Petition “Do Stuff!”")
        end
      end
    end
  end
