        ...
        describe 'for an open petition' do
          ...
          describe 'with valid params' do
            ...
            it 'tells the moderator that their changes were saved' do
              do_post
              expect(flash[:notice]).to eq 'Created related activity successfully'
            end
      ...
      context 'when clicking the Save button' do
        ...
        describe 'for an open petition' do
          ...
          describe 'with valid params' do
            ...
            it 'tells the moderator that their changes were saved' do
              do_patch
              expect(flash[:notice]).to eq 'Updated related activity successfully'
            end
      ...
      describe 'for an open petition' do
        ...
        context "when the delete is successful" do
          ...
          it 'tells the moderator that the record was deleted' do
            do_delete
            expect(flash[:notice]).to eq 'Deleted related activity successfully'
          end
        end
        ...
        context "when the delete is unsuccessful" do
          ...
          it 'tells the moderator to contact support' do
            do_delete
            expect(flash[:notice]).to eq 'Unable to delete related activity - please contact support'
          end
        end
      end
    end
