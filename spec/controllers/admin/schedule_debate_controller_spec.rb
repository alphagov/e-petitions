...
RSpec.describe Admin::ScheduleDebateController, type: :controller do
  ...
  describe "logged in as moderator user" do
    ...
    describe 'GET /show' do
      shared_examples_for 'viewing scheduled debate date' do
        ...
        it 'responds successfully and renders the schedule_debate/show template' do
          get :show, petition_id: petition.id
          expect(response).to be_success
          expect(response).to render_template('schedule_debate/show')
        end
      end
    ...
    describe 'PATCH /update' do
      ...
      def do_patch(overrides = {})
        params = { petition_id: petition.id, petition: scheduled_debate_date_attributes }
      ...
      describe 'scheduling a debate date for a petition' do
        ...
        describe 'with invalid params' do
          ...
          it 're-renders the schedule_debate/show template' do
            do_patch
            expect(response).to be_success
            expect(response).to render_template('schedule_debate/show')
          end
