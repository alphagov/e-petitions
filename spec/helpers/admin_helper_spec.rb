...
RSpec.describe AdminHelper, type: :helper do
  describe "#admin_petition_facets_for_select" do
    ...
    it "generates the correct option for 'awaiting_debate_date'" do
      expect(subject).to have_css("option:nth-of-type(13)[value='awaiting_debate_date']", text: "Awaiting a debate by the Senedd (13)")
    end

    it "generates the correct option for 'with_debate_outcome'" do
      expect(subject).to have_css("option:nth-of-type(14)[value='with_debate_outcome']", text: "Has been debated by the Senedd (14)")
    end
