...
RSpec.describe MarkdownHelper, type: :helper do
  describe "#markdown_to_html" do
    it "converts markdown to html" do
      expect(helper.markdown_to_html("## Petitions: Welsh Government and Parliament")).to eq(%[<h2>Petitions: Welsh Government and Parliament</h2>\n])
    end
  ...
  describe "#markdown_to_text" do
    it "converts markdown to text" do
      expect(helper.markdown_to_text("## Petitions: Welsh Government and Parliament")).to eq(%[Petitions: Welsh Government and Parliament\n])
    end
