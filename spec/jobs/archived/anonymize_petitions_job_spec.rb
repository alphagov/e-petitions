...
RSpec.describe Archived::AnonymizePetitionsJob, type: :job do
  ...
  context "for a petition closed in the winter" do
    let!(:petition) {
      FactoryBot.create(:archived_petition, :closed, closed_at: "2017-12-29T10:00:00Z")
    }
  ...
  context "for a petition closed in the summer" do
    let!(:petition) {
      FactoryBot.create(:archived_petition, :closed, closed_at: "2018-06-29T10:00:00Z")
    }
