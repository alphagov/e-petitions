...
Scenario: Charlie creates our petition
  ...
  And I fill in "e-petition action" with "Give half of Wimbledon rock to wombats!"	
...
Scenario: Charlie tries to submit an invalid petition without javascript.
  ...
  And the "e-petition action" row should display as invalid
  ...
  And I select "Department for International Development" from "Department"
  And I fill in "e-petition action" with "This text is longer than 200 characters. 01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"		
  ...
  And the "e-petition action" field should contain "This text is longer than 200 characters. 01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"
...
Scenario: Charlie tries to submit an invalid petition with javascript.
  ...
  And I fill in "e-petition action" with "This text is longer than 200 characters. 012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"
  And I fill in "e-petition details" with "This text is longer than 1000 characters. "
  ...
  And I fill in "e-petition action" with "Give half of Wimbledon rock to wombats!" within "//fieldset[1]"
