Feature: Dashboard todo list
  ...
  Background:
    ...
    And a petition "p1" exists with title: "Petition 1", department: department "DFID", state: "validated", created_at: "2009-02-10"
    And an open petition "p2" exists with title: "Petition 2", department: department "DFID", created_at: "2008-10-09"
    And a petition "p3" exists with title: "Petition 3", department: department "Treasury", state: "validated", created_at: "2010-11-11"
    And a petition "p4" exists with title: "Petition 4", department: department "Treasury", state: "validated", created_at: "2010-01-01"
  ...
  Scenario: Pending petitions are paginated
    Given I am logged in as a sysadmin
    And 20 petitions exist with state: "validated"
    When I go to the admin todolist page
    And I follow "Next"
