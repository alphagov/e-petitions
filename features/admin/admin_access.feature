Feature: Restricted access to the admin console
  ...
  Scenario: Login and logout to the admin console as a sysadmin
    Given a sysadmin user exists with email: "admin@example.com", password: "Shebang22!", password_confirmation: "Shebang22!"
  ...
  Scenario: Login and logout to the admin console as an admin
    Given an admin user exists with email: "admin@example.com", password: "Shebang22!", password_confirmation: "Shebang22!"
    When I go to the admin login page
    And I fill in "Email" with "admin@example.com"
    And I fill in "Password" with "Shebang22!"
    And I press "Log in"
  ...
  Scenario: Login and logout to the admin console as a threshold user
    Given a threshold user exists with email: "admin@example.com", password: "Shebang22!", password_confirmation: "Shebang22!"
    When I go to the admin login page
    And I fill in "Email" with "admin@example.com"
    And I fill in "Password" with "Shebang22!"
    And I press "Log in"
  ...
  Scenario: Login as a user who hasn't changed their password for over 9 months
    Given an admin user exists with email: "admin@example.com", password: "Shebang22!", password_confirmation: "Shebang22!", password_changed_at: "10 months ago"
    When I go to the admin login page
    And I fill in "Email" with "admin@example.com"
    And I fill in "Password" with "Shebang22!"
    And I press "Log in"
  ...
  Scenario: Login as a user who is logging in for the first time
    Given an admin user exists with email: "admin@example.com", password: "Shebang22!", password_confirmation: "Shebang22!", force_password_reset: true
    When I go to the admin login page
    And I fill in "Email" with "admin@example.com"
    And I fill in "Password" with "Shebang22!"
    And I press "Log in"
